...
module.exports = function (app) {
    app.on(['pull_request.opened', 'pull_request.edited', 'pull_request.synchronize'], function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, c.getConfig(context, pr.base.ref)];
                case 2:
                    config = _a.sent();
